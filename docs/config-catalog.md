...
Source: [`packages/core/agent-loop/src/index.ts:269`](../packages/core/agent-loop/src/index.ts)
...
Source: [`packages/hooks/hooks-notify/src/index.ts:30`](../packages/hooks/hooks-notify/src/index.ts)
...
Source: [`packages/session/session-title-first-prompt-llm/src/index.ts:25`](../packages/session/session-title-first-prompt-llm/src/index.ts)
