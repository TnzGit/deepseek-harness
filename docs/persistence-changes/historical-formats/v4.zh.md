---
description: "完整的 Session V4 持久化类型、来源证据和物理编码参考。"
...
查看 fork 集成分支在 V5 写入版本变更之前捕获的 V4 持久化类型。V4 引入工具角色结果、原生 developer 消息和严格的生命周期准入；本快照保留该检查点的声明类型。
...
来源是 PR #7 中写入 V4 的集成树，选取时间早于 V5 写入版本变更。V4 schema 从隔离的检出目录归档，没有修改其声明。该检查点不是产品发布；发布证据由[版本与发布状态参考](../../session-format-status.zh.md)维护。

<a id="characteristics"></a>
## 格式特征

逻辑头和物理头均使用版本 4。V4 将工具结果保存为工具角色消息，并接纳 developer 消息和由生产者标记的来源信息。其物理行沿用 V2 的封装方式，[V4 codec 准入](../../../packages/session/session-format-v3-to-v4/README.zh.md)验证新增语义。[V4 到 V5 迁移](../../../packages/session/session-format-v4-to-v5/README.zh.md)只提升版本，不重写历史事件。

<a id="declaration"></a>
## 声明

[Schema 清单](v4.schema.json)。
...
roots:
  ...
  "event:schedule/change": a0a2e5c42e1c929445ecd1cd70f49be6b66441894ec72c08e8ae332821d4a3cb
...
[完整机器目录](v4.schema.json)包含 62 个根类型和 586 种可达类型。摘要包含所有引用字段；源码名称和路径描述所选的历史源码树。
...
来源：`packages/preset/agent-preset-registry/src/session.ts`
...
来源：`packages/extensions/cordis-host-runner/src/index.ts`
...
[`event:agent/inbox/spliced.data.inserted.item.source.variant-84.entries.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-84entriesitem) 的数组。
...
[`event:agent/inbox/spliced.data.inserted.item.source.variant-86.references.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86referencesitem) 的数组。
...
| `capturedThroughSeq` | 必需 | [`packages/core/session/src/types.ts#OptionalSessionSeq`](#persistence-type-packagescoresessionsrctypestsoptionalsessionseq) |
...
| `form` | 必需 | `"snapshot"` |
| `kind` | 必需 | `"hooks-claude-code"` |
| `sections` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-87.sections`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-87sections) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `args` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
| `dt` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
| `id` | 必需 | `string` |
| `index` | 必需 | `number` |
| `name` | 可选 | `string` |
| `time0` | 必需 | `number` |
...
| `dt` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
| `index` | 必需 | `number` |
| `texts` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
| `time0` | 必需 | `number` |
...
| `commandId` | 必需 | `string` |
| `name` | 必需 | `string` |
| `source` | 必需 | [`packages/interaction/commands/src/types.ts#CommandSource`](#persistence-type-packagesinteractioncommandssrctypestscommandsource) |
...
| `turn` | 必需 | [`packages/core/session/src/types.ts#OptionalSessionSeq`](#persistence-type-packagescoresessionsrctypestsoptionalsessionseq) |
...
| `shadowedSeqs` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
...
| `model` | 必需 | `string` |
| `provider` | 必需 | `string` |
| `rawOutput` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content`](#persistence-type-eventagentinboxspliceddatainserteditemcontent) |
| `shadowedRange` | 必需 | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
| `shadowedTokenCount` | 必需 | `number` |
| `sourceCommandId` | 可选 | `string` |
| `summary` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content`](#persistence-type-eventagentinboxspliceddatainserteditemcontent) |
| `usage` | 可选 | [`packages/llm/llm/src/types.ts#TokenUsage`](#persistence-type-packagesllmllmsrctypeststokenusage) |
...
| `model` | 必需 | `string` |
| `provider` | 必需 | `string` |
| `rawOutput` | 可选 | [`event:agent/inbox/spliced.data.inserted.item.content`](#persistence-type-eventagentinboxspliceddatainserteditemcontent) |
| `shadowedRange` | 必需 | [`event:compaction/prune.data.shadowedRange`](#persistence-type-eventcompactionprunedatashadowedrange) |
| `shadowedSeqs` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
| `shadowedTokenCount` | 必需 | `number` |
| `sourceCommandId` | 可选 | `string` |
...
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
| `surfaceOp` | 必需 | [`packages/core/session/src/types.ts#SurfaceOp`](#persistence-type-packagescoresessionsrctypestssurfaceop) |
| `time` | 必需 | `number` |
...
| `meta` | 可选 | [`packages/util/values/src/index.ts#JsonValue`](#persistence-type-packagesutilvaluessrcindextsjsonvalue) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
[`packages/util/values/src/index.ts#JsonValue`](#persistence-type-packagesutilvaluessrcindextsjsonvalue) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| [`string`] | 索引签名 | [`packages/util/values/src/index.ts#JsonValue`](#persistence-type-packagesutilvaluessrcindextsjsonvalue) |
...
| 位置 | 存在性 | 类型 |
|---|---|---|
| 0 | 必需 | [`event:web/deepseek-search-llm-request.data.body.messages.item-0`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessagesitem-0) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `content` | 必需 | [`event:web/deepseek-search-llm-request.data.body.messages.item-0.content`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodymessagesitem-0content) |
| `role` | 必需 | `"user"` |
...
| 位置 | 存在性 | 类型 |
|---|---|---|
| 0 | 必需 | [`packages/llm/llm/src/types.ts#TextBlock`](#persistence-type-packagesllmllmsrctypeststextblock) |
...
| 位置 | 存在性 | 类型 |
|---|---|---|
| 0 | 必需 | [`event:web/deepseek-search-llm-request.data.body.tools.item-0`](#persistence-type-eventwebdeepseek-search-llm-requestdatabodytoolsitem-0) |
...
| `name` | 可选 | `string` |
| `originalDimensions` | 可选 | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-5.attachment.originalDimensions`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-5attachmentoriginaldimensions) |
| `width` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `imageIndexes` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
| `seq` | 必需 | `number` |
...
来源：`packages/compaction/compaction/src/checkpoint.ts`
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `action` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-79.changes.item.action`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79changesitemaction) |
| `digest` | 可选 | `string` |
| `path` | 必需 | `string` |
| `scope` | 必需 | `string` |
...
| `changes` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-79.changes`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-79changes) |
| `form` | 必需 | `"instructions"` |
...
| `references` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-86.references`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-86references) |
| `version` | 必需 | `1` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `allow` | 可选 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
| `deny` | 可选 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
...
| `content` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.content`](#persistence-type-eventagentinboxspliceddatainserteditemcontent) |
| `error` | 可选 | [`event:tool/ptc-dispatch.data.error`](#persistence-type-eventtoolptc-dispatchdataerror) |
| `isError` | 必需 | `boolean` |
| `name` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blockedBy` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
| `description` | 必需 | `string` |
| `id` | 必需 | `string` |
| `ownerId` | 可选 | `string` |
| `revision` | 必需 | `number` |
...
| `subject` | 必需 | `string` |
| `writeScopes` | 必需 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
...
| `kind` | 必需 | `"goal/change"` |
| `operation` | 必需 | [`event:goal/change.data.variant-1.operation`](#persistence-type-eventgoalchangedatavariant-1operation) |
...
| `provider` | 必需 | `string` |
| `reasoningEffort` | 可选 | `string` |
| `stop` | 可选 | [`event:assistant/attempt.data.stream.item.variant-0.args`](#persistence-type-eventassistantattemptdatastreamitemvariant-0args) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blocks` | 可选 | [`event:assistant/attempt.data.stream.item.variant-1.chunk.variant-5.replayState.blocks`](#persistence-type-eventassistantattemptdatastreamitemvariant-1chunkvariant-5replaystateblocks) |
...
| `description` | 必需 | `string` |
| `name` | 必需 | `string` |
| `parameters` | 必需 | [`event:request/header.data.header.tools.item.parameters`](#persistence-type-eventrequestheaderdataheadertoolsitemparameters) |
...
|---|---|---|
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`SessionEventEnvelope.variant-0.sourceEventSeqs`](#persistence-type-sessioneventenvelopevariant-0sourceeventseqs) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `entries` | 必需 | [`event:agent/inbox/spliced.data.inserted.item.source.variant-84.entries`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-84entries) |
| `form` | 必需 | `"catalog"` |
...
|---|---|---|
| `content` | 必需 | `string` |
| `status` | 必需 | [`event:todo/write.data.todos.item.status`](#persistence-type-eventtodowritedatatodositemstatus) |
...
归档命令从隔离的 V5 变更前检出目录捕获全部 V4 根类型和可达声明类型，并移除源码行号。清单描述声明，不覆盖所有物理 codec、插件载荷或生命周期规则。pnpm run verify-persistence-formats 可离线检查格式覆盖和 schema 一致性，但不会重放历史应用。
