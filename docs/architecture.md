...
turn/start
  ...
  -> agent/pre-step                   reject | enter(messages, startsRequestSeries?)
     ...
     output-limited content -> logged internal user/message -> next step, within safety limits
...
Output-limited content continues through logged plugin input; compaction and reasoning effort persist, subject to repetition and safety limits.
