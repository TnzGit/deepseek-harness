...
export const zh = {
  ...
  'message.maxTokens.autoContinuationExhausted': 'DSH 已自动续跑一次，但恢复请求仍达到输出 token 上限。已有输出保留在对话中；发送“继续”可再次接着输出。',
...
export const en = {
  ...
  'message.maxTokens.autoContinuationExhausted': 'DSH continued automatically once, but the recovery request also reached the output token limit. Earlier output is preserved; send "continue" to resume again.',
