...
export const en = {
  ...
  retryDelayStrategy: 'Retry delay',
  retryDelayInherited: 'Provider default',
  retryDelayFixed: 'Fixed',
  retryDelayExponential: 'Increasing',
  retryDelayInheritedHint: 'Uses the provider default bounded exponential delay with jitter.',
  retryDelayFixedMs: 'Fixed delay (ms)',
  retryDelayInitialMs: 'Initial delay (ms)',
  retryDelayMaxMs: 'Maximum delay (ms)',
  retryDelayFixedHint: 'Every eligible retry waits exactly this long.',
  retryDelayExponentialHint: 'The delay doubles after each failure until it reaches the maximum.',
  retryDelayInvalid: 'Enter a whole number of milliseconds from 1 to 2147483647.',
  retryDelayOrderInvalid: 'Initial delay cannot exceed maximum delay.',
  models: 'Models',
  ...
  defaultReasoningCapability: 'Default reasoning capability',
  modelReasoningCapability: 'Reasoning capability',
  reasoningInherit: 'Automatic / inherit',
  reasoningDisabled: 'Disabled',
  reasoningEnabled: 'Enabled — choose levels',
  reasoningLevels: 'Available reasoning levels',
  reasoningLevel: 'Reasoning level',
  defaultReasoningHint: 'Used only for manually listed models the installed catalog does not describe. A model-specific setting overrides it.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  retryDelayStrategy: '重试延迟',
  retryDelayInherited: '提供方默认',
  retryDelayFixed: '固定延迟',
  retryDelayExponential: '逐渐增加',
  retryDelayInheritedHint: '使用提供方默认的有上限指数退避，并带随机抖动。',
  retryDelayFixedMs: '固定延迟（毫秒）',
  retryDelayInitialMs: '起始延迟（毫秒）',
  retryDelayMaxMs: '最大延迟（毫秒）',
  retryDelayFixedHint: '每次符合条件的重试都会精确等待该时长。',
  retryDelayExponentialHint: '每次失败后延迟翻倍，达到最大延迟后不再增加。',
  retryDelayInvalid: '请输入 1 到 2147483647 之间的整数毫秒值。',
  retryDelayOrderInvalid: '起始延迟不能大于最大延迟。',
  models: '模型目录',
  ...
  modelAdvanced: '模型选项',
  defaultReasoningCapability: '默认推理能力',
  modelReasoningCapability: '推理能力',
  reasoningInherit: '自动判断／继承',
  reasoningDisabled: '关闭',
  reasoningEnabled: '开启并选择档位',
  reasoningLevels: '可用推理档位',
  reasoningLevel: '推理档位',
  defaultReasoningHint: '仅用于已安装目录无法描述的手工模型；单模型设置优先于此默认值。',
  addModel: '添加模型',
  removeModel: '删除模型',
