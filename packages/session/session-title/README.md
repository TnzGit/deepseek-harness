...
Forks inherit title events in their seed unchanged. The first-prompt cadence does not automatically retitle a child; the all-messages and every-nth-prompt cadences may append a new revision after the child receives a later human prompt.
