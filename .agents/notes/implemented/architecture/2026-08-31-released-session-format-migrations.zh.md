...
[V4 到 V5 规范](../../../../packages/session/session-format-v4-to-v5/README.zh.md#v4-to-v5-specification)保留 V4 事件身份与继承切点，同时把 header 推进到 V5 写入版本。固定的 V4 目录读取 V3 到 V4 父目录补全所需的子会话证据，不让这些子会话经过当前写入版本。原生 V5 恢复复用 V4 家族关系规则，但验证 V5 投递归属。
