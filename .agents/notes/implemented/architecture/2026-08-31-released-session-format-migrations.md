...
The [V4-to-V5 specification](../../../../packages/session/session-format-v4-to-v5/README.md#v4-to-v5-specification) preserves V4 event identities and inherited cuts while advancing the header to the V5 writer. A fixed V4 catalog reads child evidence for V3-to-V4 parent completion without passing those children through the installed writer. V5 native restoration reuses V4-family relationships but validates V5 delivery ownership.
