...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/hooks/hooks-notify': { kind: 'none', reason: 'Outbound-only notifications register no prompt, schema, context message, or session event visible to the model.' },
